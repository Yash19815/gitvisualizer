      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-[1100px] max-w-[95vw] max-h-[90vh] flex flex-col overflow-hidden border border-gray-200 dark:border-gray-800 animate-in zoom-in-95 duration-200">
        ...
        <div className="relative px-6 py-5 border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Repository Statistics</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">Insights and analytics for your repository</p>
              </div>
            </div>
            <button
        ...
        {activeTabInfo && (
          <div className="px-6 py-3 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            <p className="text-sm text-gray-500 dark:text-gray-400">{activeTabInfo.description}</p>
          </div>
        )}
          ...
          {isLoading ? (
            <div className="flex flex-col items-center justify-center h-64 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">Analyzing repository data...</p>
              </div>
            </div>
          ) : statsError ? (
            <div className="flex flex-col items-center justify-center h-64 gap-4">
              ...
              <div className="text-center">
                <p className="text-sm font-medium text-red-600 dark:text-red-400">Failed to load statistics</p>
                <p className="text-xs text-gray-500 dark:text-gray-500 mt-1 max-w-xs">{statsError}</p>
              </div>
            </div>
          ) : (
            <div className="p-6">
